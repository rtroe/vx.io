...
// -- vxAuiTabArt class implementation --
...
wxAuiTabArt* vxAuiTabArt::Clone()
{
    return new vxAuiTabArt(*this);
}

void vxAuiTabArt::SetFlags(unsigned int flags)
{
    m_flags = flags;
}

void vxAuiTabArt::SetSizingInfo(const wxSize& tab_ctrl_size,
                                      size_t tab_count)
{
    m_fixedTabWidth = 100;
...
void vxAuiTabArt::SetColour(const wxColour& colour)
{
...
void vxAuiTabArt::SetActiveColour(const wxColour& colour)
{
    m_selectedBkBrush = wxBrush(colour);
    m_selectedBkPen = wxPen(colour);
}

void vxAuiTabArt::DrawBorder(wxDC& dc, wxWindow* wnd, const wxRect& rect)
{
...
void vxAuiTabArt::DrawBackground(wxDC& dc,
...
void vxAuiTabArt::DrawTab(wxDC& dc,
                                wxWindow* wnd,
...
int vxAuiTabArt::GetIndentSize()
{
    return 0;
}

int vxAuiTabArt::GetBorderWidth(wxWindow* wnd)
{
...
int vxAuiTabArt::GetAdditionalBorderSpace(wxWindow* WXUNUSED(wnd))
{
    return 0;
}

wxSize vxAuiTabArt::GetTabSize(wxDC& dc,
                                     wxWindow* WXUNUSED(wnd),
...
void vxAuiTabArt::DrawButton(wxDC& dc,
                                   wxWindow* WXUNUSED(wnd),
                                   const wxRect& in_rect,
                                   int bitmap_id,
                                   int button_state,
...
int vxAuiTabArt::ShowDropDown(wxWindow* wnd,
...
int vxAuiTabArt::GetBestTabCtrlSize(wxWindow* wnd,
...
void vxAuiTabArt::SetNormalFont(const wxFont& font)
{
    m_normalFont = font;
}

void vxAuiTabArt::SetSelectedFont(const wxFont& font)
{
    m_selectedFont = font;
}

void vxAuiTabArt::SetMeasuringFont(const wxFont& font)
{
...
// -- vxDefaultAuiTabArt class implementation --

vxDefaultAuiTabArt::vxDefaultAuiTabArt()
{
    m_normalFont = *wxNORMAL_FONT;
    m_selectedFont = *wxNORMAL_FONT;
    m_selectedFont.SetWeight(wxFONTWEIGHT_BOLD);
...
wxAuiTabArt* vxDefaultAuiTabArt::Clone()
{
    return new vxDefaultAuiTabArt(*this);
}

void vxDefaultAuiTabArt::SetFlags(unsigned int flags)
{
    m_flags = flags;
}

void vxDefaultAuiTabArt::SetSizingInfo(const wxSize& tab_ctrl_size,
                                       size_t tab_count)
{
    m_fixedTabWidth = 100;
...
void vxDefaultAuiTabArt::DrawBorder(wxDC& dc, wxWindow* wnd, const wxRect& rect)
{
    int i, border_width = GetBorderWidth(wnd);
...
void vxDefaultAuiTabArt::DrawBackground(wxDC& dc,
                                        wxWindow* WXUNUSED(wnd),
                                        const wxRect& rect)
{
    // draw background
...
void vxDefaultAuiTabArt::DrawTab(wxDC& dc,
                                 wxWindow* wnd,
                                 const wxAuiNotebookPage& page,
                                 const wxRect& in_rect,
                                 int close_button_state,
...
*/
    ...
    dc.SetClippingRegion(tab_x, tab_y, clip_width+tab_height+1, tab_height-3);
    ...
    if (m_flags &wxAUI_NB_BOTTOM)
    {
        ...
        border_points[6] = wxPoint(tab_x+tab_width,   tab_y);
    }
...
//        border_points[5] = wxPoint(tab_x+tab_width,   tab_y+tab_height-4);
    ...
    border_points[0].x = tab_x;
    border_points[0].y = tab_y + tab_height - 1;
    
    border_points[1].x = tab_x + tab_height - 3;
    border_points[1].y = tab_y + 2;
    
    border_points[2].x = tab_x + tab_height + 3;
    border_points[2].y = tab_y;
    
    border_points[3].x = tab_x + tab_width - 3;
    border_points[3].y = tab_y;
    
    border_points[4].x = tab_x + tab_width + 3;
    border_points[4].y = tab_y + 2;
    
    border_points[5].x = tab_x + tab_width + tab_height;
    border_points[5].y = tab_y + tab_height - 1;
...
//    border_points[2].x = tab_x + tab_height + 3;
//    border_points[2].y = tab_y;
//    border_points[3].x = tab_x + tab_width - 2;
//    border_points[3].y = tab_y;
//    border_points[4].x = tab_x + tab_width;
//    border_points[4].y = tab_y + 2;
//    border_points[5].x = tab_x + tab_width;
//    border_points[5].y = tab_y + tab_height - 1;
//    border_points[6] = border_points[0];
    }
    // TODO: else if (m_flags &wxAUI_NB_LEFT) {}
    ...
    if (page.active)
    {
        ...
        text_colour = IsDarkColour(m_baseColour) ? wxColour(225,225,225) : *wxBLACK;
...
//        dc.GradientFillLinear(r, bottom_color, top_color, wxNORTH);
        ...
        // draw active tab
        dc.DrawPolygon(WXSIZEOF(border_points) - 1, border_points);
    }
    else
    {
        // draw inactive tab
        ...
        text_colour = IsDarkColour(bottom_color) ? wxColour(200,200,200) : *wxBLACK;
    ...
    if (page.bitmap.IsOk())
    {
        bitmap_offset = tab_x + tab_height;
...
int vxDefaultAuiTabArt::GetIndentSize()
{
    return 5;
}

int vxDefaultAuiTabArt::GetBorderWidth(wxWindow* wnd)
{
    wxAuiManager* mgr = wxAuiManager::GetManager(wnd);
    if (mgr)
    {
...
int vxDefaultAuiTabArt::GetAdditionalBorderSpace(wxWindow* WXUNUSED(wnd))
{
    return 0;
}

wxSize vxDefaultAuiTabArt::GetTabSize(wxDC& dc,
                                      wxWindow* WXUNUSED(wnd),
                                      const wxString& caption,
...
void vxDefaultAuiTabArt::DrawButton(wxDC& dc,
                                    wxWindow* WXUNUSED(wnd),
                                    const wxRect& in_rect,
                                    int bitmap_id,
                                    int button_state,
...
int vxDefaultAuiTabArt::ShowDropDown(wxWindow* wnd,
                                     const wxAuiNotebookPageArray& pages,
                                     int /*active_idx*/)
{
    wxMenu menuPopup;
...
int vxDefaultAuiTabArt::GetBestTabCtrlSize(wxWindow* wnd,
                                           const wxAuiNotebookPageArray& pages,
...
void vxDefaultAuiTabArt::SetNormalFont(const wxFont& font)
{
    m_normalFont = font;
}

void vxDefaultAuiTabArt::SetSelectedFont(const wxFont& font)
{
    m_selectedFont = font;
}

void vxDefaultAuiTabArt::SetMeasuringFont(const wxFont& font)
{
    m_measuringFont = font;
}

void vxDefaultAuiTabArt::SetColour(const wxColour& colour)
{
    m_baseColour = colour;
...
void vxDefaultAuiTabArt::SetActiveColour(const wxColour& colour)
{
