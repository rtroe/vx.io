...
$(IntermediateDirectory)/src_Find.cpp$(ObjectSuffix): src/Find.cpp $(IntermediateDirectory)/src_Find.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Users/Robert/Documents/GitHub/vx.io/vxpad/src/Find.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_Find.cpp$(ObjectSuffix) $(IncludePath)
